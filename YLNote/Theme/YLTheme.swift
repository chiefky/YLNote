...
class YLTheme: NSObject {
    ...
    @objc static let defaultInstance: YLTheme = {
    ...
    @objc let mainColor:UIColor = #colorLiteral(red: 0.9372549057, green: 0.3490196168, blue: 0.1921568662, alpha: 1)
    ...
    @objc let textFont = UIFont.systemFont(ofSize: 16)
    @objc let subtextFont = UIFont.systemFont(ofSize: 13)
